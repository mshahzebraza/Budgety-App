...
var AppController = ( function (budgetCtrl , UICtrl) {
    ...
    return {
        ...
        fetchFromData: function (q) {
            ...
            // mData(q); // also does not work bcz AppController.fetchFromData(q) simply runs the fetchDromData method and not the function inside it.. 
